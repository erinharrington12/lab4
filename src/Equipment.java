...
public class Equipment
{
    ...
    public boolean equals(Object other)
    {
        ...
        boolean sameName = this.getName().contentEquals(otherEq.getName());
        ...
        boolean sameDescrip = this.getDescription().equals(otherEq.getDescription());
        
        if (sameName && sameCount && sameWeight && samePrice && sameDescrip == true)
        {
        	return true;
        } else {
        	return false;
